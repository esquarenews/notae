namespace :meetings do
  ...
  task schedule_due: :environment do
    Notae::ScheduledTaskStore.track!("meetings:schedule_due") do
  ...
  task reconcile_runs: :environment do
    Notae::ScheduledTaskStore.track!("meetings:reconcile_runs") do
  ...
  task retry_failed_processing: :environment do
    Notae::ScheduledTaskStore.track!("meetings:retry_failed_processing") do
